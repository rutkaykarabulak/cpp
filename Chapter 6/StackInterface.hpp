 ...
 * File that represents ADT Stack
*/
...
public:
    ...
    @post If the operation was successful, newEntry is at the top of the stack. @param newEntry The object to be added as a new entry.
